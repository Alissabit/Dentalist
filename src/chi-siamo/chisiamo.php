    ...
    <body>
        ...
        <div class="container mt-5">
            <div class="text-center mb-5">
                ...
                <h5>La nostra missione è prenderci cura del vostro sorriso con professionalità e dedizione.</h5>
            </div>
            ...
            <div class="row align-items-center my-5">
                <div class="col-lg-6">
                    <img src="/_utilities-condivise/immagini/chisiamo.jpg" class="img-fluid rounded mb-4 mb-lg-0" alt="Clinica Dentistica">
                </div>
                <div class="col-lg-6">
                    <h2>Benvenuti da Dentalist!</h2>
                    <p>La nostra missione è prenderci cura del vostro sorriso con professionalità e dedizione. Fondata nel 2005, la nostra clinica ha aiutato oltre <b>10,000 pazienti</b> a raggiungere e mantenere una salute orale ottimale.</p>
